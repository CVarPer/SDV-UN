...
add_custom_target(sdv_serial_generate_messages ALL)
...
_generate_module_cpp(sdv_serial
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/sdv_serial
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(sdv_serial_generate_messages_cpp
...
add_custom_target(sdv_serial_gencpp)
add_dependencies(sdv_serial_gencpp sdv_serial_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS sdv_serial_generate_messages_cpp)
...
### Generating Module File
_generate_module_eus(sdv_serial
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/sdv_serial
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(sdv_serial_generate_messages_eus
...
# target for backward compatibility
add_custom_target(sdv_serial_geneus)
add_dependencies(sdv_serial_geneus sdv_serial_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS sdv_serial_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(sdv_serial
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/sdv_serial
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(sdv_serial_generate_messages_lisp
...
# target for backward compatibility
add_custom_target(sdv_serial_genlisp)
add_dependencies(sdv_serial_genlisp sdv_serial_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS sdv_serial_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(sdv_serial
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/sdv_serial
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(sdv_serial_generate_messages_nodejs
...
# target for backward compatibility
add_custom_target(sdv_serial_gennodejs)
add_dependencies(sdv_serial_gennodejs sdv_serial_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS sdv_serial_generate_messages_nodejs)
...
### Generating Module File
_generate_module_py(sdv_serial
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/sdv_serial
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(sdv_serial_generate_messages_py
...
# target for backward compatibility
add_custom_target(sdv_serial_genpy)
add_dependencies(sdv_serial_genpy sdv_serial_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS sdv_serial_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/sdv_serial)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/sdv_serial
    DESTINATION ${gencpp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_cpp)
  add_dependencies(sdv_serial_generate_messages_cpp std_msgs_generate_messages_cpp)
endif()

if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/sdv_serial)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/sdv_serial
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(sdv_serial_generate_messages_eus std_msgs_generate_messages_eus)
endif()

if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/sdv_serial)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/sdv_serial
    DESTINATION ${genlisp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_lisp)
  add_dependencies(sdv_serial_generate_messages_lisp std_msgs_generate_messages_lisp)
endif()

if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/sdv_serial)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/sdv_serial
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(sdv_serial_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/sdv_serial)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/sdv_serial\")")
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/sdv_serial
    DESTINATION ${genpy_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_py)
  add_dependencies(sdv_serial_generate_messages_py std_msgs_generate_messages_py)
endif()
