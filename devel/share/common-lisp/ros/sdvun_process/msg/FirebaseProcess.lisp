...
(cl:in-package sdvun_process-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <FirebaseProcess>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FirebaseProcess)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sdvun_process-msg:<FirebaseProcess> is deprecated: use sdvun_process-msg:FirebaseProcess instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <FirebaseProcess>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdvun_process-msg:key-val is deprecated.  Use sdvun_process-msg:key instead.")
  (key m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <FirebaseProcess>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdvun_process-msg:value-val is deprecated.  Use sdvun_process-msg:value instead.")
  (value m))
